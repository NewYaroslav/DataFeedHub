...
# Inputs:  DFH_DEPS_MODE, DFH_DEPS_MDBX_MODE, DFH_SDK_BUNDLE_DEPS
...
function(dfh_use_or_fetch_mdbx out_target)
    # ---- Effective mode ----
    set(mode "${DFH_DEPS_MDBX_MODE}")
    if(mode STREQUAL "INHERIT")
        set(mode "${DFH_DEPS_MODE}")
    endif()
